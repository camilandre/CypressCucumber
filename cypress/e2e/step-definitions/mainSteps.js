...
Given(
  "I click on the title name for the product named {string}",
  (productName) => {
...
Given(
  "I click on the add to cart button for the product named {string}",
  (productName) => {
...
Given(
  "I check that the price for the product {string} is {string}",
...
Given(
  "I check that the active sorts option is {string}",
  (activeSortingOption) => {
...
Given(
  "I check that the first product of the list contain {string}",
  (productContent) => {
...
Given(
  "I check that the last product of the list contain {string}",
  (productContent) => {
...
Given(
  "I select the option {string} from the sorting dropdown",
  (productContent) => {
